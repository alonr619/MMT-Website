...
<div class="header flex" style="height: {height}vh;">   
    {#if visible}
        <div in:fly="{{ y: -20, duration: 700 }}" class="minidiv">
            ...
            <Link url="https://www.contestdojo.com" target="_blank" className="topbuttons registrationButton" text="Register on ContestDojo!" textColor="white" visitedColor="white" />
        </div>
