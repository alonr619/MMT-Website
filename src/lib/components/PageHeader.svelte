...
<div class="header flex" style="height: {height}vh;">   
    {#if visible}
        <div in:fly="{{ y: -20, duration: 700 }}" class="minidiv">
            ...
            <Link url={button_url} target="_blank" className="topbuttons registrationButton" text={button_text} textColor="white" visitedColor="white" id={button_id} button_id="registerOnContestDogo" />
        </div>
