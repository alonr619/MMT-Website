...
<Dropdown mainText="General Rules">
    <ol>
        ...
        <li>All communication will take place through the Discord platform.</li>
            <ol type="a">
