...
<div style="margin-left: 10vw; margin-right: 10vw;">
    <PanelBox>
        <p style="font-size: 1.5em; text-align: center;"><strong>Notice:</strong><br /> We are mainly recruiting for Tournament Development from specific regions. However, you may get the opportunity to join other teams.</p>
    </PanelBox>
</div> <br />
