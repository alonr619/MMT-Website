...
<div class="page"></div>
<PageHeader title="Mustang Math Tournament (MMT) Online" description="April 29, 2023: 9:00 AM - 4:30 PM PT" button_url="https://contestdojo.com" button_text="Register for Competition!" button_id="registerOnContestDojo" target="_blank" />
...
<div style="margin-left: 10vw; margin-right: 10vw;">
    <CardPanelBox initials="MM">
        ...
        <p>
            ...
            <strong>LATE COST:</strong> $20 per participant (Register before <strong>April 27th, 2023</strong> to participate)<br /> <br />
