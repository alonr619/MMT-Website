...
<PageHeader title="Mustang Math Tournament (MMT) California" description="April 29, 2023: 9:00 AM - 4:30 PM PT" button_url="https://contestdojo.com" button_text="Register for Competition!" button_id="registerForCompetition" target="_blank" />
...
<div style="margin-left: 10vw; margin-right: 10vw;">
    <PanelBox>
        ...
        <p>
            ...
            <strong>LOCATION:</strong> Washington (Eastside Seattle)<br />
