...
<svelte:head>
    <title>MMT 2024 IL</title>
</svelte:head>

<svelte:window bind:innerWidth={windowWidth} />

<div class="page"></div>
<PageHeader title="Mustang Math Tournament (MMT) Illinois" description="April 27, 2024: 9:00 AM - 5:00 PM PT" button_url="http://tinyurl.com/MMT2024Registration" button_text="Register for Competition!" button_id="registerOnContestDojo" target="_blank" />
