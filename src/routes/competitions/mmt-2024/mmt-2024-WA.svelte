<script>
    ...
    let windowWidth;
    const scheduleData = [
        { "Day": "4/15-4/19", "Start Time (PT)": "All Day", "Event": "Problem of the Day" },
        [ "4/20", "8:30 AM-9:00 AM", "Check-in" ],
        [ "4/20", "9:00 AM-9:30 AM", "Opening Ceremony & Contest Instructions" ],
        [ "4/20", "9:30 AM-10:55 AM", "Mounting Mayhem (75 minutes)" ],
        [ "4/20", "10:55 AM-12:05 PM", "Herding Hexes (60 minutes) " ],
        [ "4/20", "12:05 PM-1:00 PM", "Lunch Break (55 minutes)" ],
        [ "4/20", "1:00 PM-2:10 PM", "Mystery Mare (60 minutes)" ],
        [ "4/20", "2:10 PM-3:20 PM", "Gallop (60 minutes)" ],
        [ "4/20", "3:20 PM-4:30 PM", "Optional Activities" ],
        [ "4/20", "4:30 PM", "Awards Ceremony" ]
    ];
...
<svelte:head>
    <title>MMT 2024 WA</title>
</svelte:head>

<svelte:window bind:innerWidth={windowWidth} />

<div class="page"></div>
<PageHeader title="Mustang Math Tournament (MMT) Washington" description="April 20, 2024: 9:00 AM - 5:00 PM PT" button_url="http://tinyurl.com/MMT2024Registration" button_text="Register for Competition!" button_id="registerOnContestDojo" target="_blank" />
...
<div style="margin-left: 10vw; margin-right: 10vw;">
    <CardPanelBox initials="MM">
        ...
        <p>
            ...
            <strong>LOCATION:</strong> Bellevue, Washington<br />
            <strong>EARLY HORSE COST:</strong> $15 per participant (Register before <strong>March 14th, 2024</strong>)<br />
            <strong>NORMAL COST:</strong> $20 per participant (Register before <strong>April 10th, 2024</strong>)<br /> <br />
            <strong>LATE COST:</strong> $25 per participant (Register before <strong>April 17th, 2024</strong>)<br /> <br />
