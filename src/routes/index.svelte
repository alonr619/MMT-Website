  ...
  <div class="header flex">
    {#if visible}
      <div in:fly={{ y: -20, duration: 700 }} class="minidiv">
        ...
        >
          Mustang Math [MM] is a 501(c)(3) nonprofit organization of committed
          high school and college volunteers who are dedicated to promoting a
          spirit of collaboration among middle school students around the world
          and piquing their curiosity in mathematics.
        </p>
        ...
        <button
          ...
          <span class="hidden">Newspaper icon</span> Sign Up for our Newsletter</button
        >
      </div>
