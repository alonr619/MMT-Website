    ...
    <div class="header flex">
        {#if visible}
            <div in:fly={{ y: -20, duration: 700 }} class="minidiv">
                ...
                >
                    Mustang Math [MM] is an online middle school contest
                    designed around values of collaboration, love for
                    mathematics, and fun
                </p>
                <a sveltekit:prefetch href="/classes" class="headerButton">
                    ...
                    >
                        <p class="headerButton" id="signupformmclasses">
                            Sign up for Mustang Math Classes!
                        </p>
                        <img
                            height="25px"
                            class="headerButton"
