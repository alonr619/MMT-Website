...
<PageHeader title="Meet the Team" description="THE ONES MAKING MMT POSSIBLE" button_url="https://contestdojo.com/" button_text="Register on ContestDojo!"/>
<section>
	<br />
	<FlexBox wrap={true}>
		...
		<Person pic="about-us-images/Tristan_Kay-modified-min.png" name="Tristan Kay" />
	...
	<div style="display: flex; justify-content: center; align-items: center;">
		{#if windowWidth > 800}
		<div style="width: 25%;display: flex; justify-content: center; align-items: center;"><ul>
			<li>Aarjav Jain</li>
			<li>Adam Zweiger</li>
